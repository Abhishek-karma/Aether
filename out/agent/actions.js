...
exports.shouldRequireFileActions = shouldRequireFileActions;
exports.createActiveEditorFallbackAction = createActiveEditorFallbackAction;
...
function normalizeAction(action) {
    ...
    if ((candidate.type === 'create' || candidate.type === 'edit') &&
...
function extractFencedFileActions(response) {
    const actions = [];
...
function extractMarkdownFileActions(response) {
    const actions = [];
...
function extractFirstPlainCodeBlock(response) {
...
function looksLikeProjectFile(file) {
...
function insertAtPosition(original, offset, insertion) {
